...
public class gems {
	...
	@SidedProxy(clientSide="modGems.common.ClientProxy", serverSide="modGems.common.CommonProxy")
	...
	public void load(FMLInitializationEvent event){
		...
		AmetrineOre = new AmetrineOre(ConfigData.AMETRINE_ORE, 0).setHardness(3F).setResistance(3F).setBlockName("ametrine_ore");
		GameRegistry.registerBlock(AmetrineOre);
		LanguageRegistry.addName(AmetrineOre,  "Ametrine Ore");
		BerylStone = new BerylStone(ConfigData.BERYL_STONE, 1).setHardness(3F).setResistance(3F).setBlockName("beryl");
		GameRegistry.registerBlock(BerylStone);
		LanguageRegistry.addName(BerylStone,  "Beryl");
		SapphireOre = new SapphireOre(ConfigData.SAPPHIRE_ORE, 2).setHardness(3F).setResistance(3F).setBlockName("sapphire_ore");
		GameRegistry.registerBlock(SapphireOre);
		LanguageRegistry.addName(SapphireOre,  "Sapphire Ore");
		OnyxOre = new OnyxOre(ConfigData.ONYX_ORE, 3).setHardness(3F).setResistance(3F).setBlockName("onyx_ore");
		GameRegistry.registerBlock(OnyxOre);
		LanguageRegistry.addName(OnyxOre,  "Onyx Ore");
		FossilStone = new FossilStone(ConfigData.FOSSIL_STONE, 4).setHardness(3F).setResistance(3F).setBlockName("fossil_stone");
		GameRegistry.registerBlock(FossilStone);
		LanguageRegistry.addName(FossilStone,  "Fossils");
		AmethystOre = new AmethystOre(ConfigData.AMETHYST_ORE, 5).setHardness(3F).setResistance(3F).setBlockName("amethyst_ore");
		GameRegistry.registerBlock(AmethystOre);
		LanguageRegistry.addName(AmethystOre,  "Amethyst Ore");
		QuartzOre = new QuartzOre(ConfigData.QUARTZ_ORE, 6).setHardness(3F).setResistance(3F).setBlockName("quartz_ore");
		GameRegistry.registerBlock(QuartzOre);
		LanguageRegistry.addName(QuartzOre,  "Quartz");
		AmethystBlock = new AmethystBlock(ConfigData.AMETHYST_BLOCK, 7, Material.rock).setHardness(5F).setResistance(10F).setBlockName("amethyst_block");
		GameRegistry.registerBlock(AmethystBlock);
		LanguageRegistry.addName(AmethystBlock,  "Block of Amethyst");
		SapphireBlock = new SapphireBlock(ConfigData.SAPPHIRE_BLOCK, 8, Material.rock).setHardness(10F).setResistance(10F).setBlockName("sapphire_block");
		GameRegistry.registerBlock(SapphireBlock);
		LanguageRegistry.addName(SapphireBlock,  "Block of Sapphire");
		AmetrineBlock = new AmetrineBlock(ConfigData.AMETRINE_BLOCK, 9, Material.rock).setHardness(7F).setResistance(10F).setBlockName("ametrine_block");
		GameRegistry.registerBlock(AmetrineBlock);
		LanguageRegistry.addName(AmetrineBlock,  "Block of Ametrine");
		GemBoxBlock = new GemBoxBlock(ConfigData.GEM_BOX_BLOCK, 0).setHardness(3F).setResistance(3F).setBlockName("display_box");
		GameRegistry.registerBlock(GemBoxBlock);
		LanguageRegistry.addName(GemBoxBlock,  "Display Box");
		BlackOnyxBlock = new BlockOnyxBlock(ConfigData.BLACK_ONYX_BLOCK, 12, Material.rock).setHardness(5F).setResistance(10F).setBlockName("black_onyx_block");
		GameRegistry.registerBlock(BlackOnyxBlock);
		LanguageRegistry.addName(BlackOnyxBlock, "Black Onyx Block");
		CitrineBlock = new CitrineBlock(ConfigData.CITRINE_BLOCK, 11, Material.rock).setHardness(5F).setResistance(10F).setBlockName("citrine_block");
		GameRegistry.registerBlock(CitrineBlock);
		LanguageRegistry.addName(CitrineBlock, "Block of Citrine");
		AmberBlock = new AmberBlock(ConfigData.AMBER_BLOCK, 13, Material.rock).setHardness(7F).setResistance(10F).setBlockName("amber_block");
		GameRegistry.registerBlock(AmberBlock);
		LanguageRegistry.addName(AmberBlock, "Block of Amber");
		RedBerylBlock = new RedBerylblock(ConfigData.RED_BERYL_BLOCK, 15, Material.rock).setHardness(7F).setResistance(10F).setBlockName("red_beryl_block");
		GameRegistry.registerBlock(RedBerylBlock);
		LanguageRegistry.addName(RedBerylBlock, "Red Beryl Block");
		
		
		AmetrineGem = new AmetrineGem(ConfigData.AMETRINE_GEM);
		RedBerylGem = new RedBerylGem(ConfigData.RED_BERYL_GEM);
		AquamarineGem = new AquamarineGem(ConfigData.AQUAMARINE_GEM);
		HeliodorGem = new HeliodorGem(ConfigData.HELIODOR_GEM);
		SapphireGem = new SapphireGem(ConfigData.SAPPHIRE_GEM);
		OnyxGem = new OnyxGem(ConfigData.ONYX_GEM);
		AmberGem = new AmberGem(ConfigData.AMBER_GEM);
		CitrineGem = new CitrineGem(ConfigData.CITRINE_GEM);
		AmethystGem = new AmethystGem(ConfigData.AMETHYST_GEM);
		AmethystDust = new AmethystDust(ConfigData.AMETHYST_DUST);
		CitrineDust = new CitrineDust(ConfigData.CITRINE_DUST);
		AmetrineDust = new AmetrineDust(ConfigData.AMETRINE_DUST);
		CompressedSapphire = new CompressedSapphire(ConfigData.COMPRESSED_SAPPHIRE);
		Sardonyx = new Sardonyx(ConfigData.SARDONYX_GEM);
		...
		GameRegistry.registerWorldGenerator(new modGems.common.WorldOreGen());
