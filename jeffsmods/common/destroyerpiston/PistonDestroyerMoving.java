...
public class PistonDestroyerMoving extends BlockContainer
{
    public PistonDestroyerMoving(int par1)
    {
    ...
    {
        return new TileEntityDestructionPiston(par0, par1, par2, par3, par4);
    }
