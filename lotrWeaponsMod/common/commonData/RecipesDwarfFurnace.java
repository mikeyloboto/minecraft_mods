...
public class RecipesDwarfFurnace
{
    ...
    {
        this.addSmelting(LotrWeapons.ElvenAlloy.shiftedIndex, new ItemStack(LotrWeapons.ElvenAlloyIngot), 0.0F);
        this.addSmelting(LotrWeapons.CondensedLightChunk.shiftedIndex, new ItemStack(LotrWeapons.CondensedCrystal), 0.0F);
    }
