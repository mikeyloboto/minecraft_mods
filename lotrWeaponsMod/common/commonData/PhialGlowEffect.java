...
public class PhialGlowEffect {
	...
	if (world.getBlockId(pX[1],  pY[1],  pZ[1]) == controlBlock && !(pX[1]==pX[arrayPar1-1] && pY[1]==pY[arrayPar1-1] && pZ[1]==pZ[arrayPar1-1]))
	...
	if (currentBlock==0)
	{
		...
		//world.setBlock(x, y, z, net.minecraft.block.Block.obsidian.blockID);
	}
