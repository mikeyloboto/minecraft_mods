...
public class LotrWeapons
	...
	static EnumToolMaterial enumToolMaterialLight = EnumHelper.addToolMaterial("lightCrystal", 2, 17852, 10F, 15, 20);
	...
	ElvenAlloy = new lotrWeaponsMod.common.items.ElvenAlloy(ConfigData.ELVEN_ALLOY);
	ElvenAlloyIngot = new lotrWeaponsMod.common.items.ElvenAlloyIngot(ConfigData.ELVEN_ALLOY_INGOT);
	AerialFuel = new lotrWeaponsMod.common.items.AerialFuel(ConfigData.AERIAL_FUEL);
	LightCrystalShard = new lotrWeaponsMod.common.items.LightCrystalShard(ConfigData.CONDENSED_LIGHT_CRYSTAL_SHARD);
	CondensedLightChunk = new lotrWeaponsMod.common.items.CondensedLightChunk(ConfigData.CONDENSED_LIGHT_CHUNK);
	CondensedCrystal = new lotrWeaponsMod.common.items.CondensedCrystal(ConfigData.CONDENSED_CRYSTALIZED_LIGHT);
	CondensedLightBottle = new lotrWeaponsMod.common.items.CondensedLightBottle(ConfigData.CONDENSED_LIGHT_BOTTLE);
	GlowingPhial = new lotrWeaponsMod.common.tools.GlowingPhial(ConfigData.GLOWING_PHIAL);
	SwordSting = new lotrWeaponsMod.common.tools.SwordSting(ConfigData.SWORD_STING, enumToolMaterialLight);
	SwordGlamdring = new lotrWeaponsMod.common.tools.SwordGlamdring(ConfigData.SWORD_GLAMDRING, enumToolMaterialElvenAlloy);
	SwordNarsil = new lotrWeaponsMod.common.tools.SwordNarsil(ConfigData.SWORD_NARSIL, enumToolMaterialElvenAlloy);
	
	
	
	DwarfFurnace = new lotrWeaponsMod.common.blocks.DwarfFurnaceBlock(ConfigData.DWARF_FURNACE, false).setHardness(20F).setResistance(300F).setBlockName("dwarf_furnace");
	GameRegistry.registerBlock(DwarfFurnace);
	LanguageRegistry.addName(DwarfFurnace,  "Dwarf Furnace");
	AerialMaterial = new lotrWeaponsMod.common.blocks.AerialMaterial(ConfigData.AERIAL_MATTER, 4, Material.glass).setHardness(1F).setResistance(0.1F).setBlockName("aerial_material");
	GameRegistry.registerBlock(AerialMaterial);
	LanguageRegistry.addName(AerialMaterial, "Aerial Matter");
	DwarfFurnaceCasing = new lotrWeaponsMod.common.blocks.DwarfFurnaceCasingBlock(ConfigData.DWARF_FURNACE_CASING).setHardness(10F).setResistance(10F).setBlockName("dwarf_furnace_casing");
	GameRegistry.registerBlock(DwarfFurnaceCasing);
	LanguageRegistry.addName(DwarfFurnaceCasing, "Dwarf Furnace Casing");
	CondensedLightCrystal = new lotrWeaponsMod.common.blocks.CondensedLightCrystal(ConfigData.CONDENSED_LIGHT_CRYSTAL).setHardness(1F).setResistance(1F).setBlockName("condensed_light_block");
	GameRegistry.registerBlock(CondensedLightCrystal);
	LanguageRegistry.addName(CondensedLightCrystal, "Light Crystal");
	LightBlock = new lotrWeaponsMod.common.blocks.LightBlock(ConfigData.LIGHT_BLOCK).setBlockName("light_block");
	...
	ItemStack compressedsap = new ItemStack(modGems.common.CollectibleGems.CompressedSapphire, 1);
	ItemStack diamondst = new ItemStack(net.minecraft.item.Item.diamond, 1);
	ItemStack ametrinest = new ItemStack(modGems.common.CollectibleGems.AmetrineGem, 1);
	...
	GameRegistry.registerWorldGenerator(new lotrWeaponsMod.common.commonData.Generators());
