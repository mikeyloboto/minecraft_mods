...
public class PistonDestroyerBase extends Block
{
    /** This pistons is the sticky one? */
 //no, it's not. fuck you notch
	//okay :(
	public static boolean isSticky = false;

    public PistonDestroyerBase(int par1, int par2)
    {
    	//hmmm this requires metadata for different orientations
    	//hold on
    ...
    public int getBlockTextureFromSideAndMetadata(int par1, int par2)
    {
        ...
        return var3 > 5 ? this.blockIndexInTexture : (par1 == var3 ? (!isExtended(par2) && this.minX <= 0.0D && this.minY <= 0.0D && this.minZ <= 0.0D && this.maxX >= 1.0D && this.maxY >= 1.0D && this.maxZ >= 1.0D ? this.blockIndexInTexture : 6) : (par1 == Facing.faceToSide[var3] ? 5 : 4));
    }
    @Override
    ...
    public void onBlockEventReceived(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        else if (par5 == 1)
        {
            ...
            par1World.setBlockTileEntity(par2, par3, par4, PistonDestroyerMoving.getTileEntity(this.blockID, par6, par6, false, true));
            ...
            if (this.isSticky)
            {
                ...
                if (!var13 && var11 > 0 && canPushBlock(var11, par1World, var8, var9, var10, false) && (Block.blocksList[var11].getMobilityFlag() == 0 || var11 == Block.pistonBase.blockID || var11 == Block.pistonStickyBase.blockID))
                {
                    ...
                    par1World.setBlockTileEntity(par2, par3, par4, PistonDestroyerMoving.getTileEntity(var11, var12, par6, false, false));
            ...
            { 
                ...
                if (var12 == this.blockID && var9 == par2 && var10 == par3 && var11 == par4)
                {
                	...
                	if (par1World.getBlockId(var6,  var7, var8) !=0){
                		Block.blocksList[par1World.getBlockId(var6, var7, var8)].dropBlockAsItem(par1World, var6, var7, var8, par1World.getBlockMetadata(var6, var7, var8), 0);
                	}
                	par1World.setBlockAndMetadataWithUpdate(var6, var7, var8, DestructivePiston.PistonDestroyerHead.blockID, par5 | (this.isSticky ? 8 : 0), false);
                    par1World.setBlockTileEntity(var6, var7, var8, PistonDestroyerMoving.getTileEntity(DestructivePiston.PistonDestroyerHead.blockID, par5 | (this.isSticky ? 8 : 0), par5, true, false));
                }
                else
                {
                    //par1World.setBlockAndMetadataWithUpdate(var6, var7, var8, DestructivePiston.PistonDestroyerHead.blockID, var13, false);
                    par1World.setBlockTileEntity(var6, var7, var8, PistonDestroyerMoving.getTileEntity(var12, var13, par5, true, false));
                }
