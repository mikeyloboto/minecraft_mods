...
public class PistonDestroyerHead extends Block
{
    /** The texture for the 'head' of the piston. Sticky or normal. */
    private int headTexture = -1;

    public PistonDestroyerHead(int par1, int par2)
    {
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        if (var8 == DestructivePiston.PistonDestroyerBase.blockID)
        {
            par6 = par1World.getBlockMetadata(par2, par3, par4);

            if (PistonDestroyerBase.isExtended(par6))
            {
    ...
    public int getBlockTextureFromSideAndMetadata(int par1, int par2)
    {
        ...
        return par1 == var3 ? (this.headTexture >= 0 ? this.headTexture : ((par2 & 8) != 0 ? this.blockIndexInTexture : this.blockIndexInTexture)) : (var3 < 6 && par1 == Facing.faceToSide[var3] ? 3 : 3);
    }
    @Override
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        if (var7 != DestructivePiston.PistonDestroyerBase.blockID)
        {
            par1World.setBlockWithNotify(par2, par3, par4, 0);
        }
        else
