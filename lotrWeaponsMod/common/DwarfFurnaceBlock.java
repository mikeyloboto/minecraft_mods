...
public class DwarfFurnaceBlock extends BlockContainer
{
    ...
    protected DwarfFurnaceBlock(int par1, boolean par3)
    {
  ...
  public String getTextureFile () {
    ...
    public boolean onBlockActivated(World par1World, int x, int y, int z, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
     if (par1World.isRemote)
        ...
        {
            TileEntityDwarfFurnace blockEntity = (TileEntityDwarfFurnace)par1World.getBlockTileEntity(x, y, z);

            if (blockEntity != null)
            {
             if(blockEntity instanceof TileEntityDwarfFurnace)
             {
            	 TileEntityDwarfFurnace var6 = (TileEntityDwarfFurnace)par1World.getBlockTileEntity(x, y, z);
            	 par5EntityPlayer.openGui(lotrWeapons.instance, 1, par1World, x, y, z);
             }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            TileEntityDwarfFurnace var7 = (TileEntityDwarfFurnace)par1World.getBlockTileEntity(par2, par3, par4);
