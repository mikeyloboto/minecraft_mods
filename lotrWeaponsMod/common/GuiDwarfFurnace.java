...
public class GuiDwarfFurnace extends GuiContainer
{
    ...
    public GuiDwarfFurnace(InventoryPlayer inventoryplayer, TileEntityDwarfFurnace tileentitydwarffurnace)
    {
        super(new ContainerDwarfFurnace(inventoryplayer, tileentitydwarffurnace));
