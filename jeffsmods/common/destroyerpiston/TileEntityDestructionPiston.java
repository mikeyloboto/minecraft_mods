...
public class TileEntityDestructionPiston extends TileEntity
{
    ...
    public TileEntityDestructionPiston() {}

    public TileEntityDestructionPiston(int par1, int par2, int par3, boolean par4, boolean par5)
    {
    ...
    private void updatePushedObjects(float par1, float par2)
    {
        ...
        AxisAlignedBB var3 = DestructivePiston.PistonDestroyerMoving.getAxisAlignedBB(this.worldObj, this.xCoord, this.yCoord, this.zCoord, this.storedBlockID, par1, this.storedOrientation);
