...
public class GemBoxModel extends ModelBase
{
  ...
  public GemBoxModel()
  {
    ...
    textureHeight = 64;
      ...
      Shape1.addBox(-8F, 23F, -8F, 16, 1, 16);
      ...
      Shape10.addBox(0F, 0F, 0F, 12, 1, 12);
      Shape10.setRotationPoint(-6F, 22F, -6F);
  ...
  public void render(float scale, double x, double y, double z, float ang, float angY, boolean par1, boolean par2, boolean par3)
  {
      GL11.glPushMatrix();
