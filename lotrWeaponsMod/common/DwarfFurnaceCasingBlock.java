...
public void onBlockAdded(World par1World, int i, int j, int k)
{
    ...
    boolean var2 = par1World.getBlockId(i+1, j-1, k+1) == modGems.common.gems.AmethystBlock.blockID && par1World.getBlockId(i+1, j-1, k-1) == modGems.common.gems.AmethystBlock.blockID && par1World.getBlockId(i-1, j-1, k+1) == modGems.common.gems.AmethystBlock.blockID && par1World.getBlockId(i-1, j-1, k-1) == modGems.common.gems.AmethystBlock.blockID;
    boolean var3 = par1World.getBlockId(i,  j-1, k) == modGems.common.gems.SapphireBlock.blockID;
